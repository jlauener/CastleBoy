...
#define OLED_WIDTH 128 /**< The width of the display in pixels */
#define OLED_HEIGHT 64 /**< The height of the display in pixels */

#define COLUMN_ADDRESS_END (112 - 1) & 127   // 128 pixels wide
#define PAGE_ADDRESS_END ((OLED_HEIGHT/8)-1) & 7    // 8 pages high
...
namespace core
{
     ...
     */
    void digitalWriteRGB(uint8_t color, uint8_t val);
     ...
     */
    void delayShort(uint16_t ms) __attribute__ ((noinline));
